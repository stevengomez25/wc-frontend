        ...
        >
            ...
            >
                ...
                <div className="p-4 text-left">
                    ...
                    <p className="text-neutral-500 text-xs mb-2">Colección Hombre</p>
...
export default function MensPage() {
    const [menProducts, setMenProducts] = useState([]); // Base de productos de hombre
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                if (data.ok) {
                    // FILTRADO INICIAL: Solo categoría "men"
                    const mensOnly = data.products.filter(p => p.category === "men");
                    setMenProducts(mensOnly);
                    setFilteredProducts(mensOnly);
                }
            } catch (error) {
    ...
    // Lógica de Filtrado y Ordenamiento basada en el Schema
    useEffect(() => {
        ...
        // 2. Filtro por talla (Buscando dentro del array de variants)
        if (filters.size) {
        ...
        // 3. Disponibilidad (Usando el campo stock general o suma de variants)
    ...
    }, [filters, sortBy, menProducts]);

    // Componente reutilizable de controles de filtro para evitar repetición
    const FilterControls = () => (
        <>
            ...
            <div className="flex items-center mb-6">
                ...
                />
                <label htmlFor="stock-men" className="ml-2 text-sm text-neutral-700">Solo en stock</label>
            </div>
            ...
            <header className="bg-white shadow-sm sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
                    <Link to="/" className="text-2xl font-extrabold tracking-tighter text-neutral-900 uppercase">
                        VestiRápido <span className="text-sm font-light text-neutral-500 ml-2">MEN</span>
                    </Link>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <aside className="hidden md:block w-64 flex-shrink-0">
                        <div className="sticky top-24">
                            <h3 className="text-lg font-bold text-neutral-900 mb-4 uppercase tracking-widest border-b pb-2">Filtros Hombre</h3>
                            <FilterControls />
                        </div>
                    </aside>
                    ...
                    <div className="flex-1">
                        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 pb-4 border-b border-neutral-200">
                            <h2 className="text-xl font-bold text-neutral-800 uppercase tracking-tight mb-4 sm:mb-0">
                                Ropa para Caballero <span className="text-neutral-400 font-light">({filteredProducts.length})</span>
                            </h2>
                        ...
                        {filteredProducts.length === 0 ? (
                            <div className="text-center py-20 bg-white rounded-xl shadow-inner">
                                <p className="text-neutral-400 italic">No hay productos de hombre que coincidan.</p>
                            </div>
                        ) : (
